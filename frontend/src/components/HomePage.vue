<template>
  <div>
    ...
    <p>{{ backendData }}</p>
    <p v-if="showAuthMessage" class="auth-message">User not identified yet. Please log in.</p>
...
export default defineComponent({
  ...
  setup() {
    ...
    const showAuthMessage = computed(() => route.query.authRequired === 'true');
  ...
  function generateRandomString(length: any) {
    ...
    return { backendData, fetchData, loginWithSpotify, showAuthMessage };
  },
  mounted() {
